...
puts "3 - Creating team + assign team to owner"
puts ""

Team.create!(name: "La Boutique du vélo",
            owner_id: User.find_by_email('boss@boutique.com').id
  )
...
# cree user "no solution" pour le cas ci-dessous
